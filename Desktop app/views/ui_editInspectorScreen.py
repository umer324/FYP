...
# Form implementation generated from reading ui file 'editInspectorScreen.ui'
#
...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Desktop App/icons/24x24/cil-plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addInspector.setIcon(icon)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addInspector.setText(_translate("MainWindow", "Update Inspector"))
        ...
        self.label_title_bar_top.setText(_translate("MainWindow", "Edit Inspector Detail"))
